(() => {
	...
	*/
	...
	// Set to true to log the entered keys to the console as they are pressed.
	// This is useful when building your cheat code.
	const logKeysToConsole = false
	...
	*/
	...
	// Optionally, log the entered keys to the console as they are pressed.
	// This is useful when building your cheat code.
	window.addEventListener("keyup", evt => {
		_pressed.push(evt.key);
		maintainPressedLength();
		isEnteredCodeCorrect();
		if (logKeysToConsole) console.log(evt.key);
	});
})();